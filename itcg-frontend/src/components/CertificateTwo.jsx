    ...
    <section className='certificate-two py-120 position-relative z-1 mash-bg-main mash-bg-main-two mash-reverse'>
      <div className='section-heading text-center'>
        ...
        <p className=' wow bounceInUp'>
          A plethora of resources and information guides for you to propel in your entrepreneurial journey, based on your current stage. For some of these resources, you may be asked to register on the itcg portal.
        </p>
      </div>
            ...
            <div className='col-lg-6 pe-lg-5'>
              ...
              >
                <div className='flex-align gap-20 mb-12'>
                  ...
                  <h5 className='mb-0'>EARLY TRACTION</h5>
                </div>
                <p className='text-neutral-700 text-line-2'>
                  Lorem ipsum dolor sit amet, conse ctetur adipisc amus ac
                  iaculis arcu.
