              ...
              <div className='about-two__thumb position-relative'>
                ...
                <div className='offer-message two px-24 py-12 rounded-12 bg-white fw-medium box-shadow-lg flex-align d-inline-flex gap-16 animation-upDown'>
                  ...
                  <div>
                    ...
                    <span>Sur tous les ateliers jeunesse à Guédiawaye</span>
                  </div>
                </div>
                <div className='offer-message style-two me-lg-0 me-24 px-24 py-12 rounded-12 bg-white fw-medium flex-align d-inline-flex gap-16 box-shadow-lg animation-upDown'>
                  <span className='flex-shrink-0 w-48 h-48 bg-main-two-600 text-white text-2xl flex-center rounded-circle'>
                    <img src='assets/images/icons/stars-white.png' alt='Avis positifs' />
                  </span>
                  <div>
                    <span className='text-lg text-neutral-700 d-block'>
                      4.8 <span className='text-neutral-100'>(3.1k)</span>
                    </span>
                    <span className='text-neutral-500'>Avis positifs des participants</span>
                  </div>
                </div>
                <div className='position-absolute inset-block-end-0 inset-inline-end-0 me-lg-0 me-24 px-24 py-12 rounded-12 bg-white fw-medium flex-align d-inline-flex gap-16 box-shadow-lg animation-upDown'>
                  <div className='text-center'>
                    ...
                    <span className='text-sm text-neutral-500'>
                      90% des jeunes formés trouvent une opportunité professionnelle
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className='about-two-content'>
                <div className='mb-40'>
                  <div className='flex-align d-inline-flex gap-8 mb-16 wow bounceInDown'>
                    ...
                    <h5 className='text-main-600 mb-0'>Pourquoi MAG ?</h5>
                  </div>
                  <h2 className='mb-24 wow bounceIn'>
                    Un incubateur au service de la jeunesse et de la culture de Guédiawaye
                  </h2>
                  <p className='text-neutral-500 text-line-2 wow bounceInUp'>
                    La Maison des Associations de Guédiawaye (MAG) est un centre innovant qui soutient les jeunes entrepreneurs, artistes, et porteurs de projets. Nous allions culture, technologie et inclusion sociale pour offrir des formations, du mentorat, et des opportunités professionnelles concrètes.
                  </p>
                </div>
                ...
                <div className='grid-cols-2'>
                  ...
                  >
                    ...
                    <div className='flex-grow-1'>
                      ...
                      <p className='text-neutral-500 text-line-2'>
                        Ateliers pratiques en numérique, design, audiovisuel et plus encore.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className='flex-grow-1'>
                      ...
                      <p className='text-neutral-500 text-line-2'>
                        Un réseau de mentors, formateurs, et experts locaux pour guider les jeunes.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className='flex-grow-1'>
                      ...
                      <p className='text-neutral-500 text-line-2'>
                        Valorisation du patrimoine culturel à travers des projets numériques créatifs.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className='flex-grow-1'>
                      ...
                      <p className='text-neutral-500 text-line-2'>
                        Création d’emplois, stages et entrepreneuriat pour garantir l’avenir des jeunes.
                      </p>
                    </div>
                  </div>
                </div>
