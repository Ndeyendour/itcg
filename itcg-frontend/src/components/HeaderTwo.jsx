...
const menuItems = [
    {
      label: "À propos",
      links: [
        { to: "/about-Two", label: "Initiative MAG" },
        // { to: "#", label: "Demander le logo MAG" },
        { to: "/blog", label: "Bulletin d'information" },
        { to: "/faq", label: "Questions fréquentes (FAQ)" },
        { to: "/plan-MAG.pdf", label: "Plan d'action d'MAG", external: true },
        { to: "/contact", label: "Contactez-nous" },
        // { to: "#", label: "Évolution d'MAG | Rapport sur 5 ans" },
        // { to: "#", label: "MAG | Perspectives d’avenir" },
      ],
    },
    {
      ...
      links: [
        ...
        { to: "/about-four", label: "Reconnaissance et avantages de l’MAG" },
        { to: "/reconnaissance", label: "Demander la reconnaissance MAG" },
        ...
        { to: "#", label: "Directives de reconnaissance MAG" },
    ...
    },
    {
      label: "Financement",
      links: [
        { to: "/about", label: "Programme de fonds d’amorçage MAG" },
        // { to: "#", label: "MAG Investor Connect" },
    ...
    },
    {
      label: "Régime",
      links: [
        { to: "/event-details", label: "Support réglementaire MAG" },
    ...
    },
    {
      ...
      links: [
        ...
        { to: "/about", label: "Programme de Financement Seed MAG" },
