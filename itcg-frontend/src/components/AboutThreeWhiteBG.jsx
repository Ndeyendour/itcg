                  ...
                  <div className='col-sm-4'>
                    ...
                    >
                      ...
                      <span className='text-white'>
                        Étudiantes actives dans notre réseau
                      </span>
                ...
                <div className='mb-40'>
                  <div className='flex-align d-inline-flex gap-8 mb-16 wow bounceInDown'>
                    ...
                    <h5 className='text-main-600 mb-0'>
                      L'entrepreneuriat féminin en Inde
                    </h5>
                  </div>
                  <h2 className='mb-24 wow bounceInRight'>
                    Stimuler la croissance par le leadership féminin
                  </h2>
                  <p className='text-neutral-500 text-line-2 wow bounceInUp'>
                    La présence croissante des femmes en tant que chefs d'entreprise a entraîné une croissance économique et commerciale significative dans le pays.
                    Les entreprises dirigées par des femmes jouent un rôle prépondérant dans la société en créant des emplois dans le pays, en entraînant des changements démographiques
                    et en inspirant la prochaine génération de fondatrices.
                    <br /><br />
                    Ayant pour objectif de promouvoir le développement durable des femmes entrepreneurs pour une croissance équilibrée dans le pays,
                    itcg s'engage à renforcer l'entrepreneuriat féminin en Inde par le biais d'initiatives, de programmes, de la création de réseaux
                    et de communautés favorables et de l'activation de partenariats entre les diverses parties prenantes de l'écosystème des startups.
                  </p>
                </div>

                <div className='grid-cols-2'>
                  {/* Icônes et catégories existantes conservées */}
                  <div className='flex-align align-items-start gap-20' data-aos='fade-up' data-aos-duration={600}>
                    ...
                    <div className='flex-grow-1'>
                      <h6 className='text-neutral-800 text-xl fw-medium mb-8'>Formation</h6>
                      <div className='flex-align gap-8 text-neutral-500'>
                        <i className='d-flex text-lg ph-bold ph-clock' /> En ligne
                      </div>
                    </div>
                  </div>

                  <div className='flex-align align-items-start gap-20' data-aos='fade-up' data-aos-duration={800}>
                    <span className='flex-shrink-0 w-60 h-60 flex-center d-inline-flex bg-white text-main-600 text-40 rounded-16 box-shadow-md'>
                      <img src='assets/images/icons/choose-us-icon2.png' className='animate__swing' alt='' />
                    </span>
                    <div className='flex-grow-1'>
                      <h6 className='text-neutral-800 text-xl fw-medium mb-8'>Mentorat</h6>
                      <div className='flex-align gap-8 text-neutral-500'>
                        <i className='d-flex text-lg ph-bold ph-clock' /> Hybride
                      </div>
                    </div>
                  </div>

                  <div className='flex-align align-items-start gap-20' data-aos='fade-up' data-aos-duration={1000}>
                    <span className='flex-shrink-0 w-60 h-60 flex-center d-inline-flex bg-white text-main-600 text-40 rounded-16 box-shadow-md'>
                      <img src='assets/images/icons/choose-us-icon3.png' className='animate__swing' alt='' />
                    </span>
                    <div className='flex-grow-1'>
                      <h6 className='text-neutral-800 text-xl fw-medium mb-8'>Financement</h6>
                      <div className='flex-align gap-8 text-neutral-500'>
                        <i className='d-flex text-lg ph-bold ph-clock' /> À la demande
                      </div>
                    </div>
                  </div>

                  <div className='flex-align align-items-start gap-20' data-aos='fade-up' data-aos-duration={1200}>
                    <span className='flex-shrink-0 w-60 h-60 flex-center d-inline-flex bg-white text-main-600 text-40 rounded-16 box-shadow-md'>
                      <img src='assets/images/icons/choose-us-icon4.png' className='animate__swing' alt='' />
                    </span>
                    <div className='flex-grow-1'>
                      <h6 className='text-neutral-800 text-xl fw-medium mb-8'>Communautés</h6>
                      <div className='flex-align gap-8 text-neutral-500'>
                        <i className='d-flex text-lg ph-bold ph-clock' /> En continu
                      </div>
                    </div>
                  </div>
                </div>
