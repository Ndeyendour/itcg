          ...
          <div className='row gy-5'>
            ...
            <div className='col-lg-3 col-sm-6' data-aos='fade-up' data-aos-duration={400}>
              <div className='footer-item'>
                ...
                <ul className='footer-menu'>
                  ...
                  <li className='mb-16'><Link to='/equipe' className='text-white hover-text-main-600 hover-text-decoration-underline'>Équipe</Link></li>
            ...
            <div className='col-lg-3 col-sm-6' data-aos='fade-up' data-aos-duration={600}>
              <div className='footer-item'>
                ...
                <ul className='footer-menu'>
                  <li className='mb-16'><Link to='/programmes' className='text-white hover-text-main-600 hover-text-decoration-underline'>Design graphique</Link></li>
                  <li className='mb-16'><Link to='/programmes' className='text-white hover-text-main-600 hover-text-decoration-underline'>Développement web</Link></li>
                  <li className='mb-16'><Link to='/programmes' className='text-white hover-text-main-600 hover-text-decoration-underline'>Audiovisuel</Link></li>
                  <li className='mb-16'><Link to='/programmes' className='text-white hover-text-main-600 hover-text-decoration-underline'>Entrepreneuriat culturel</Link></li>
                  <li className='mb-0'><Link to='/programmes' className='text-white hover-text-main-600 hover-text-decoration-underline'>Inclusion numérique</Link></li>
                </ul>
              </div>
            </div>
            ...
            <div className='col-lg-3 col-sm-6' data-aos='fade-up' data-aos-duration={800}>
              <div className='footer-item'>
                ...
                <div className='flex-align gap-20 mb-24'>
                  ...
                  <div>
                    <a href='mailto:contact@itcg.sn' className='text-white d-block hover-text-main-600 mb-4'>contact@itcg.sn</a>
                    <a href='mailto:info@itcg.sn' className='text-white d-block hover-text-main-600'>info@itcg.sn</a>
                  </div>
                </div>
                ...
                <div className='flex-align gap-20'>
                  ...
                  <div>
                    <span className='text-white d-block mb-4'>Guédiawaye, Dakar</span>
                    <span className='text-white d-block'>Centre ITCG - Liberté 6 Extension</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='container container-two'>
            <div className='bottom-footer__inner flex-between gap-16 flex-wrap'>
              ...
              <div className='footer-item__logo mb-0' data-aos='zoom-in-right'>
                <Link to='/'>
                  <img src='assets/images/logo/logo-itcg-white.png' alt='Logo ITCG' />
                </Link>
              </div>

              <p className='text-white text-line-1 fw-normal' data-aos='zoom-in'>
                © {new Date().getFullYear()} <span className='fw-semibold'>ITCG Guédiawaye</span>. Tous droits réservés.
              </p>

              <ul className='social-list flex-align gap-24' data-aos='zoom-in-left'>
                <li className='social-list__item'>
                  <a href='https://facebook.com/itcg.sn' target='_blank' rel='noopener noreferrer' className='text-white text-2xl hover-text-main-two-600'>
                    <i className='ph-bold ph-facebook-logo' />
                  </a>
                </li>
                <li className='social-list__item'>
                  <a href='https://instagram.com/itcg.sn' target='_blank' rel='noopener noreferrer' className='text-white text-2xl hover-text-main-two-600'>
                    <i className='ph-bold ph-instagram-logo' />
                  </a>
                </li>
                <li className='social-list__item'>
                  <a href='https://www.linkedin.com/company/itcg-sn' target='_blank' rel='noopener noreferrer' className='text-white text-2xl hover-text-main-two-600'>
